...
func SendHelp(agent discord.Agent) {
	discord.SendMessageWithMention("#### Admin\n\n"+
		...
		"The profile is independent of the servers\n- `!track <login>` -> Track provided discordUser, one user per server\n"+
		"- `!untrack` -> Untrack current server's discordUser (Automatically set to spectate)\n"+
